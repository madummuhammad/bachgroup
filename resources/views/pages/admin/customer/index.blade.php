    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <!-- Section 5 -->
                <div class="row mb-5">
                    <form action="{{route('admin.customer.section')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("POST")                 
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="exampleFormControlInput1" type="text" name="title" value="{{$section->title}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">
                                <img class="img-fluid flag " src="{{url('england.svg')}}" alt="">
                            </label>
                            <input class="form-control" id="exampleFormControlInput1" type="text" name="title_eng" value="{{$section->title_eng}}">
                        </div>
...
<div class="modal fade" id="hapusCustomer{{$edit->id}}" tabindex="-1" aria-labelledby="editUserLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('customer.destroy',$edit->id)}}" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
