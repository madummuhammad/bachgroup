	...
	<div class="col-12">
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				@endif
				<form action="{{route('admin.catudaya.create')}}" method="POST" enctype="multipart/form-data">
					@csrf
					@method("POST")					
					<div class="mb-3">
					...
					<div class="row mb-3">
						<div class="col-lg-4 col-12">
							<img class="img-fluid" src="{{url('/')}}/{{$item->section_2_sub_1_image}}" alt="">
							<input type="file" accept=".png,.jpg,.jpeg" class="form-control mt-2" name="section_2_sub_1_image">
							<div class="d-flex justify-content-between align-items-center">
								<div class="col">Alt Text</div>
								<input type="text" class="form-control mt-2 col" name="section_2_sub_1_alt_image" value="{{$item->section_2_sub_1_alt_image}}">
							</div>
						</div>
						<div class="col-lg-8 col-12">
							<div class="mb-3">
					...
					<div class="row mb-3">
						<div class="col-lg-4 col-12">
							<img class="img-fluid" src="{{url('/')}}/{{$item->section_2_sub_2_image}}" alt="">
							<input type="file" accept=".png,.jpg,.jpeg" class="form-control mt-2" name="section_2_sub_2_image">
							<div class="d-flex justify-content-between align-items-center">
								<div class="col">Alt Text</div>
								<input type="text" class="form-control mt-2 col" name="section_2_sub_2_alt_image" value="{{$item->section_2_sub_2_alt_image}}">
							</div>
						</div>
						<div class="col-lg-8 col-12">
							<div class="mb-3">
					...
					<div class="row mb-3">
						<div class="col-lg-4 col-12">
							<img class="img-fluid" src="{{url('/')}}/{{$item->section_2_sub_3_image}}" alt="">
							<input type="file" accept=".png,.jpg,.jpeg" class="form-control mt-2" name="section_2_sub_3_image">
							<div class="d-flex justify-content-between align-items-center">
								<div class="col">Alt Text</div>
								<input type="text" class="form-control mt-2 col" name="section_2_sub_3_alt_image" value="{{$item->section_2_sub_3_alt_image}}">
							</div>
						</div>
						<div class="col-lg-8 col-12">
							<div class="mb-3">
								...
								<textarea name="section_2_sub_3_description" id="" cols="30" rows="10" class="summernote">{{$item->section_2_sub_3_description}}</textarea>
							</div>
							<div class="mb-3">
								<label class="form-label" for="exampleFormControlInput1">
									<img class="img-fluid flag " src="{{url('england.svg')}}" alt="">
								</label>
								<textarea id="" cols="30" rows="10" class="summernote" name="section_2_sub_3_description_eng">{{$item_eng->section_2_sub_3_description}}</textarea>
							</div>
						</div>
					</div>
					<!-- End Section 2 -->
					...
					<!-- End Section 3 -->
					<div class="col-lg-12">
						<button class="btn btn-primary mb-2" type="button"  data-coreui-toggle="modal" data-coreui-target="#tambahItem">Tambah Proyek</button>
						<table class="table table-bordered">
							...
							<tbody>
								...
								$no=1;
								@endphp
								@foreach($project as $key => $item_project)
								<tr>
									<th scope="row">{{$no++}}</th>
									<td>{{$item_project->title}}</td>
									<td>
										<!-- 										<div class="img-thumbnail"> -->
											<img style="width: 100px" src="{{url('/')}}/{{$item_project->image}}" alt="">
											<!-- </div> -->
										</td>
										<td>
											@php
											echo $item_project->description
											@endphp
											------------
											<br>
											@php
											echo $item_project->eng->description
											@endphp
										</td>
										<td>
		...
		<div class="modal fade" id="tambahItem" tabindex="-1" aria-labelledby="tambahItemLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="{{route('admin.catudaya.project.create')}}" method="POST" enctype="multipart/form-data">
						<div class="modal-header">
							<h5 class="modal-title" id="tambahItemLabel">Tambah Proyek</h5>
							<button class="btn-close" type="button" data-coreui-dismiss="modal" aria-label="Close"></button>
						</div>
						<div class="modal-body">
							@method("POST")
		...
		@foreach($project as $key => $item_project)
		<div class="modal fade" id="editItem{{$item_project->id}}" tabindex="-1" aria-labelledby="tambahItemLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="{{route('admin.catudaya.project.update',$item_project->id)}}" method="POST" enctype="multipart/form-data">
						<div class="modal-header">
						...
						<div class="modal-body">
							...
							<div class="mb-3">
								...
								<textarea name="description" id="" cols="30" rows="10" class="summernote">{{$item_project->description}}</textarea>
							</div>
							<div class="mb-3">
								<label class="form-label" for="exampleFormControlInput1">
									<img class="img-fluid flag " src="{{url('england.svg')}}" alt="">
								</label>
								<textarea id="" cols="30" rows="10" class="summernote" name="description_eng">{{$item_project->eng->description}}</textarea>
							</div>
							<div class="mb-3">
								<img class="img-fluid" src="{{url('/')}}/{{$item_project->image}}" alt="">
								<input type="file" accept=".png,.jpg,.jpeg" class="form-control mt-2" name="image">
							</div>
						</div>
						<div class="modal-footer">
