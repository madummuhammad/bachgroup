...
<div class="row">
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header"><strong>Footer dan Sosmed</strong></div>
            <div class="card-body">              
                <!-- Section 5 -->
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <form action="{{route('admin.footer')}}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="title" value="{{$footer->title}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput1">
                                    <img class="img-fluid flag " src="{{url('england.svg')}}" alt="">
                                </label>
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="title_eng" value="{{$footer_eng->title}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="exampleFormControlInput1">
                                    Instagram Link
                                </label>
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="ig_link" value="{{$footer->ig_link}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="exampleFormControlInput1">
                                    Facebook Link
                                </label>
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="fb_link" value="{{$footer->fb_link}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput1">
                                    <img class="img-fluid flag indonesian-flag" src="{{url('indonesia.png')}}" alt="">
                                </label>
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="copyright" value="{{$footer->copyright}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput1">
                                    <img class="img-fluid flag " src="{{url('england.svg')}}" alt="">
                                </label>
                                <input class="form-control" id="exampleFormControlInput1" type="text" name="copyright_eng" value="{{$footer_eng->copyright}}">
                            </div>
