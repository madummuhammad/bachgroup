...
class CustomercatudayaController extends Controller
{
    /**
    ...
    {
        $customers=CustomerCatudaya::orderBy('created_at','ASC')->get();
        // $section=CustomerSection::first();
        return view('pages.admin.customercatudaya.index',[
            'customers'=>$customers,
            // 'section'=>$section
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        CustomerCatudaya::where('id',$id)->update($data);
    ...
    {
        $item = CustomerCatudaya::findorFail($id);

        $item->delete();

        return redirect()
        ->route('customercatudaya.index')
